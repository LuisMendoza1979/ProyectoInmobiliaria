...
export class ClienteSolicitudController {
  ...
  async find(
    ...
    return this.clienteRepository.solicitudes_cliente(id).find(filter);
  }
  ...
  async create(
    ...
    }) solicitud: Omit<Solicitud, 'Sol_Id'>,
  ): Promise<Solicitud> {
    return this.clienteRepository.solicitudes_cliente(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.clienteRepository.solicitudes_cliente(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.clienteRepository.solicitudes_cliente(id).delete(where);
  }
}
